...
export const translations: Record<string, Record<Lang, string>> = {
  ...
  // Témoignages — texte inline supplementaires
  ...
  'temo.avisCompte':          { fr: 'Votre avis compte',          en: 'Your review matters' },
  'temo.laissezTemo':         { fr: 'Laissez votre témoignage',   en: 'Leave your testimonial' },
  'temo.partagezExp':         { fr: 'Partagez votre expérience avec le Thé Pio Pio', en: 'Share your experience with Thé Pio Pio' },
  'temo.votreNote':           { fr: 'Votre note *',               en: 'Your rating *' },
  'temo.prenom':              { fr: 'Prénom *',                   en: 'First name *' },
  'temo.votrePrenom':         { fr: 'Votre prénom',               en: 'Your first name' },
  'temo.ville':               { fr: 'Ville *',                    en: 'City *' },
  'temo.exVille':             { fr: 'ex: Cotonou',                en: 'e.g. Cotonou' },
  'temo.votreTemo':           { fr: 'Votre témoignage *',         en: 'Your testimonial *' },
  'temo.validation':          { fr: 'Votre témoignage est soumis à validation avant publication.', en: 'Your testimonial is subject to review before publication.' },
  'temo.pasClient':           { fr: 'Pas encore client ? Découvrez le Thé Pio Pio.', en: 'Not a customer yet? Discover Thé Pio Pio.' },
  'temo.commander':           { fr: 'Commander — 1 000 FCFA',     en: 'Order — 1,000 FCFA' },
  'temo.nbTemo':              { fr: 'témoignages clients',        en: 'customer testimonials' },
  'temo.nouveau':             { fr: 'Nouveau',                    en: 'New' },
  'temo.100pct':              { fr: '100% recommandent le Thé Pio Pio', en: '100% recommend Thé Pio Pio' },
  'temo.avisClients':         { fr: 'avis clients',               en: 'customer reviews' },

  // Espace client — textes supplementaires
  'espace.merciConfiance':    { fr: '— Merci de votre confiance !', en: '— Thank you for your trust!' },
  'espace.chargementEspace':  { fr: 'Chargement de votre espace…', en: 'Loading your account…' },
  'espace.doigtConnecte':     { fr: 'Vous devez être connecté pour accéder à votre espace.', en: 'You must be logged in to access your account.' },
  'espace.redirection':       { fr: 'Redirection vers la connexion…', en: 'Redirecting to login…' },
  'espace.connecterMaintenant': { fr: 'Se connecter maintenant',  en: 'Log in now' },
  'espace.espClient':         { fr: 'Espace client',              en: 'My account' },
  'espace.bonjour':           { fr: 'Bonjour',                    en: 'Hello' },
  'espace.mesInfos':          { fr: 'Mes informations',           en: 'My information' },
  'espace.nomComplet':        { fr: 'Nom complet',                en: 'Full name' },
  'espace.email':             { fr: 'Email',                      en: 'Email' },
  'espace.tel':               { fr: 'Téléphone',                  en: 'Phone' },
  'espace.membreDepuis':      { fr: 'Membre depuis',              en: 'Member since' },
  'espace.passerCmd':         { fr: 'Passer une commande',        en: 'Place an order' },
  'espace.descCommander':     { fr: 'Commandez votre Thé Pio Pio — 1 000 FCFA, livraison partout au Bénin.', en: 'Order your Thé Pio Pio — 1,000 FCFA, delivery across Benin.' },
  'espace.voirBoutique':      { fr: 'Voir la boutique',           en: 'Visit the shop' },
  'espace.laisserAvis':       { fr: '⭐ Laisser un témoignage',   en: '⭐ Leave a review' },
  'espace.descAvis':          { fr: 'Partagez votre expérience et aidez d\'autres familles à découvrir le Thé Pio Pio.', en: 'Share your experience and help other families discover Thé Pio Pio.' },
  'espace.ecrireAvis':        { fr: 'Écrire un avis',             en: 'Write a review' },
  'espace.besoinAide':        { fr: 'Besoin d\'aide ?',           en: 'Need help?' },
  'espace.descAide':          { fr: 'Notre équipe est disponible Lun–Sam 8h–18h pour toute question.', en: 'Our team is available Mon–Sat 8am–6pm for any questions.' },
  'espace.formulaire':        { fr: 'Formulaire',                 en: 'Contact form' },
  'espace.appeler':           { fr: 'Appeler',                    en: 'Call' },
  'espace.mesCommandes':      { fr: 'Mes commandes',              en: 'My orders' },
  'espace.actualiser':        { fr: 'Actualiser',                 en: 'Refresh' },
  'espace.chargementCmd':     { fr: 'Chargement de vos commandes…', en: 'Loading your orders…' },
  'espace.aucuneCmd':         { fr: 'Vous n\'avez pas encore passé de commande.', en: 'You haven\'t placed any orders yet.' },
  'espace.decouvrirBtq':      { fr: 'Découvrir la boutique',     en: 'Discover the shop' },
  'espace.commandeHash':      { fr: 'Commande #',                 en: 'Order #' },
  'espace.detail':            { fr: 'Détail :',                   en: 'Details:' },
  'espace.total':             { fr: 'Total :',                    en: 'Total:' },
  'espace.suivreWhatsApp':    { fr: 'Suivre via WhatsApp',        en: 'Track via WhatsApp' },
  'espace.misAJour':          { fr: 'Mis à jour à',               en: 'Updated at' },
  'espace.infoPerso':         { fr: 'Info personnelles',          en: 'Personal info' },
  'espace.msgAnnulee':        { fr: 'Cette commande a été annulée. Contactez-nous au', en: 'This order has been cancelled. Contact us at' },

  // Erreur / 404
  'error.quelquechose':       { fr: 'Quelque chose s\'est mal passé.', en: 'Something went wrong.' },
  'error.reesayer':           { fr: 'Réessayer',                  en: 'Try again' },
  'error.retourAccueil':      { fr: 'Retour à l\'accueil',        en: 'Back to home' },
  'error.pageIntrouvable':    { fr: 'Page introuvable',           en: 'Page not found' },
  'error.pageEvaporee':       { fr: 'Cette page s\'est évaporée… comme une goutte de thé dans l\'eau chaude.', en: 'This page has evaporated… like a drop of tea in hot water.' },
  'error.voirBoutique':       { fr: 'Voir la boutique',           en: 'Visit the shop' },

  // Paiement retour
  'paiement.verification':    { fr: 'Vérification en cours…',     en: 'Verification in progress…' },
  'paiement.confirmation':    { fr: 'Nous confirmons votre paiement.', en: 'We are confirming your payment.' },
  'paiement.confirme':        { fr: 'Paiement confirmé !',        en: 'Payment confirmed!' },
  'paiement.cmdPayee':        { fr: 'Votre commande #',           en: 'Your order #' },
  'paiement.cmdPayeeSuite':   { fr: 'a été payée avec succès.',   en: 'has been paid successfully.' },
  'paiement.emailEnvoye':     { fr: 'Un email de confirmation vous a été envoyé. Notre équipe vous contactera sous 2h pour la livraison.', en: 'A confirmation email has been sent. Our team will contact you within 2h for delivery.' },
  'paiement.echoue':          { fr: 'Paiement échoué',            en: 'Payment failed' },
  'paiement.echoueDetail':    { fr: 'Le paiement n\'a pas pu être effectué. Votre commande reste en attente de paiement.', en: 'The payment could not be completed. Your order is still pending payment.' },
  'paiement.retourBtq':       { fr: 'Retour à la boutique',       en: 'Back to shop' },
  'paiement.enAttente':       { fr: 'Paiement en attente',        en: 'Payment pending' },
  'paiement.cmdEnregistree':  { fr: 'Votre commande #',           en: 'Your order #' },
  'paiement.cmdEnregistreeSuite': { fr: 'est enregistrée. Notre équipe vous contactera pour confirmer.', en: 'is registered. Our team will contact you to confirm.' },
  'paiement.voirCommandes':   { fr: 'Voir mes commandes',         en: 'View my orders' },
