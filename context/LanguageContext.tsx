...
export const translations: Record<string, Record<Lang, string>> = {
  ...
  'contact.erreur':       { fr: "Erreur d'envoi. Contactez-nous directement par WhatsApp ou par email.", en: 'Send error. Contact us directly via WhatsApp or email.' },
  ...
  'temo.laisser':         { fr: 'Laisser mon avis', en: 'Leave a review' },
