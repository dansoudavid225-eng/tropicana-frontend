      ...
      <section style={{ position:'relative', height:180, overflow:'hidden' }}>
        ...
        <div style={{ position:'absolute', inset:0, background:'rgba(10,30,20,0.82)', display:'flex', alignItems:'flex-end' }}>
          <div style={{ maxWidth:1200, margin:'0 auto', width:'100%', padding:'28px 24px' }}>
            <span style={{ fontSize:13, letterSpacing:'2.5px', color:'var(--gold)', fontFamily:'Arial, sans-serif', fontWeight:700, textTransform:'uppercase' }}>{t('auth.mdpOublie')}</span>
            <h1 style={{ fontSize:28, fontWeight:400, color:'var(--text-inverse)', marginTop:6 }}>
              {lang === 'en' ? <>Reset your <em style={{ color:'var(--gold)' }}>password</em></> : <>Réinitialiser votre <em style={{ color:'var(--gold)' }}>mot de passe</em></>}
            </h1>
          </div>
        </div>
      </section>
        ...
        <div style={{ maxWidth:420, margin:'0 auto', background:'var(--bg-card)', borderRadius:16, padding:'40px 36px', border:'0.5px solid var(--border-color)', boxShadow:'0 4px 24px rgba(0,0,0,0.08)' }}>
          ...
          {status === 'sent' ? (
            <div style={{ textAlign:'center', padding:'20px 0' }}>
              <svg width="52" height="52" viewBox="0 0 24 24" fill="none" stroke="var(--green-mid)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"/></svg>
            ...
            <>
              ...
              <div style={{ marginBottom:24 }}>
                <label style={{ display:'block', fontSize:14, fontWeight:700, color:'var(--green-deep)', fontFamily:'Arial, sans-serif', marginBottom:6 }}>{t('auth.email')}</label>
