    ...
    <>
      ...
      <section style={{ background: 'var(--bg-card-alt)', padding: '60px 24px' }}>
        <div style={{ maxWidth: 760, margin: '0 auto' }}>
          ...
          <p style={{ fontSize: 15, color: 'var(--text-secondary)', fontFamily: 'Arial, sans-serif', lineHeight: 1.9, marginBottom: 28, fontWeight: 400 }}>
          ...
          <h2 style={{ fontSize: 22, fontWeight: 400, color: 'var(--text-primary)', marginBottom: 16, marginTop: 36 }}>Une plante ancestrale aux vertus prouvées</h2>
          ...
          <div style={{ background: 'var(--green-pale)', borderRadius: 10, padding: '20px 22px', marginBottom: 28, borderLeft: '4px solid #2D6A4F' }}>
            <p style={{ fontSize: 13, color: 'var(--text-primary)', fontFamily: 'Arial, sans-serif', lineHeight: 1.8, margin: 0, fontStyle: 'italic' }}>
          ...
          <h2 style={{ fontSize: 22, fontWeight: 400, color: 'var(--text-primary)', marginBottom: 16, marginTop: 36 }}>6 bienfaits clés de la verveine blanche</h2>
          ...
          {[
            ...
            <div key={item.titre} style={{ marginBottom: 24 }}>
              <h3 style={{ fontSize: 16, fontWeight: 700, color: 'var(--text-primary)', fontFamily: 'Arial, sans-serif', marginBottom: 8 }}>{item.titre}</h3>
              <p style={{ fontSize: 13, color: 'var(--text-secondary)', fontFamily: 'Arial, sans-serif', lineHeight: 1.8 }}>{item.texte}</p>
            </div>
          ))}

          <h2 style={{ fontSize: 22, fontWeight: 400, color: 'var(--text-primary)', marginBottom: 16, marginTop: 36 }}>Comment la consommer ?</h2>
          <div style={{ background: 'var(--bg-card)', border: '0.5px solid var(--border-color)', borderRadius: 10, padding: '20px 22px', marginBottom: 32 }}>
            {[
              ...
              <div key={item.qui} style={{ display: 'flex', gap: 12, marginBottom: 14, alignItems: 'flex-start' }}>
                ...
                <div>
                  <span style={{ fontWeight: 700, fontSize: 13, color: 'var(--text-primary)', fontFamily: 'Arial, sans-serif' }}>{item.qui} : </span>
                  <span style={{ fontSize: 13, color: 'var(--text-secondary)', fontFamily: 'Arial, sans-serif' }}>{item.comment}</span>
                </div>
              </div>
            ))}
          </div>
